...
candidates = [
    Candidate("C_001", "Alice", desperation=0.9, actual_skill=85, perceived_skill=80,
              expected_salary=60000, confidence=0.7, interview_experience=70, status="desperate_seeker"),
    ...
    Candidate("C_003", "Charlie", desperation=0.5, actual_skill=90, perceived_skill=85,
              expected_salary=90000, confidence=0.8, interview_experience=85, status="skilled_picky"),
    Candidate("C_004", "Diana", desperation=0.8, actual_skill=30, perceived_skill=40,
              expected_salary=40000, confidence=0.4, interview_experience=30, status="desperate_low_skill"),
    Candidate("C_005", "Eve", desperation=0.3, actual_skill=75, perceived_skill=75,
              expected_salary=85000, confidence=0.6, interview_experience=65, status="skilled_picky"),
